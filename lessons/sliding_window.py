...
def search_windows_v2(img, windows, clf, scaler, color_space='RGB',
                   spatial_size=(32, 32), hist_bins=32,
                   hist_range=(0, 256), orient=9,
                   pix_per_cell=8, cell_per_block=2,
                   hog_channel=0, spatial_feat=True,
                   hist_feat=True, hog_feat=True, y_start_stop=[None, None],scale=0):
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            # Get color features
            features = utils.single_img_features(subimg, color_space=color_space,
...
def search_windows(img, windows, clf, scaler, color_space='RGB',
    ...
    for window in windows:
        ...
        features = utils.single_img_features(test_img, color_space=color_space,
                                  spatial_size=spatial_size, hist_bins=hist_bins,
                                  orient=orient, pix_per_cell=pix_per_cell,
                                  cell_per_block=cell_per_block,
                                  hog_channel=hog_channel, spatial_feat=spatial_feat,
